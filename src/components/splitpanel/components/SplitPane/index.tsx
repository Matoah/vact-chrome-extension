...
export interface CollapseOptions {
  ...
  resizerButton: React.ReactElement;
...
export const SplitPane: React.FC<SplitPaneProps> = (props) => {
  ...
  const splitPaneClass = useMergeClasses([
    "SplitPane",
    props.split,
    props.className,
  ]);
      ...
      <React.Fragment key={paneIndex}>
        {paneIndex - 1 >= 0 ? (
          <Resizer
            ...
            split={props.split}
            className={
              resizingIndex === resizerPaneIndex
                ? resizingClass
                : props.className
            }
